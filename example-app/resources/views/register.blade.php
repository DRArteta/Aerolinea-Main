          ...
          <form class="col-12"method="POST">
            ...
            <div class="row">
              ...
              <div class="form-group col-6" id="password-group">
                ...
                <input name="password" id="password" type="password" class="form-control" placeholder="Contraseña" required onfocusout="ValidarContra()">
              </div>
            </div>
            <div class="row justify-content-center text-center">
              <div class="col-4">
                <button  type="submit"class="btn btn-info" name="submit" value="regresar"><i class="fas fa-undo-alt"></i> Regresar</button><!--fas fas-sign-in-alt: esto nos saca esa cosita rara al lado de ingresar-->
              </div>
              <div class="col-4">
