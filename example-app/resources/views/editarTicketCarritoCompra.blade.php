                      ...
                      @csrf
                        <div class="row justify-content-center form-group" id="documento-group">
                            ...
                            <div class="col-md-4">
                                <select name="tipo_id" class="form-select" aria-label="Default select example">
                                    <option selected value="<?php echo $tickete[0]->tipo_id?>"><?php echo $tickete[0]->tipo_id?></option>
                            ...
                            <div class="col-md-7">
                                <input value= "<?php echo $tickete[0]->documento?>" name="document" id="document" type="numeric" class="form-control" placeholder="Numero Documento" required onfocusout="Validar()">
                            </div>
                        </div>
                        ...
                        <div class="row justify-content-center form-group" id="name-group">
                            <div class="col-md-10">
                                ...
                                <input value= "<?php echo $tickete[0]->nombre?>" name="name" id="name" type="text" class="form-control" placeholder="Nombre Completo" required>
                            </div>
                        </div>
                        ...
                        <div class="row justify-content-center form-group" id="lastname-group">
                            <div class="col-md-10">
                                ...
                                <input value= "<?php echo $tickete[0]->apellido?>" name="lastname" id="lastname" type="text" class="form-control" placeholder="Apellido Completo" required>
                            </div>
                        </div>
                        ...
                        <div class=" row justify-content-center form-group" id="date-group">
                            <div class="col-md-10">
                                ...
                                <input value= "<?php echo $tickete[0]->fecha_de_nacimiento?>" name="date" id="date" type="date" class="form-control" placeholder="dd/mm/aa" required>
                            </div>
                        </div>
                        ...
                        <div class="row justify-content-center form-group" id="gender-group">
                            <div class="col-md-10">
                                ...
                                <select name="genero" class="form-select" aria-label="Default select example">
                                  <option selected value="<?php echo $tickete[0]->genero?>">valor guardado: <?php echo $tickete[0]->genero?></option>
                        ...
                        <div class="row justify-content-center form-group" id="telefono-group">
                            <div class="col-md-10">
                                ...
                                <input  value= "<?php echo $tickete[0]->telefono?>" name="tel" id="tel" type="number" class="form-control"  placeholder="Numero telefonico" required onfocusout="Validar()">
                            </div>
                        </div>
                        ...
                        <div class="row justify-content-center form-group" id="email-group">
                            <div class="col-md-10">
                                ...
                                <input value= "<?php echo $tickete[0]->correo_electronico?>" name="correo" id="correo" type="email" class="form-control" placeholder="Correo Electronico" required>
                            </div>
                        </div>
                        ...
                        <div class="row justify-content-center form-group" id="nameC-group">
                            <div class="col-md-10">
                                ...
                                <input value= "<?php echo $tickete[0]->nombre_de_contacto?>" name="name_contacto" id="name-contacto" type="text" class="form-control" placeholder="Nombre Completo" required>
                            </div>
                        </div>
                        ...
                        <div class="row justify-content-center form-group" id="telefonoC-group">
                            <div class="col-md-10">
                                ...
                                <input value= "<?php echo $tickete[0]->telefono_de_contacto?>" name="tel_contacto" id="tel-contacto" type="number" class="form-control" placeholder="Telefono contacto" required onfocusout="Validar()">
                            </div>
                        </div>
                        ...
                        <div class="row botones"><!--no se pueden sacar los botones del form...porque deja de funcionar...-->
                            <div class="d-grid gap-3  text-center"> <!-- d-sm-block-->
                                ...
                                <button  type="button" class="btn btn-primary" name="cancelar" value="cancelar">Cancelar</button> <!--REVISAR ESTA PARTE porque se pueden seleccionar los 2-->
                            </div>
                        </div>
